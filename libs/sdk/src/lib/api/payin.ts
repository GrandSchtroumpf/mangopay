import { Api, MangoPayContext, Address, CountryISO, Language, Money, CardType, BrowserInfo, PaymentType } from "../type";
...
export interface PayinCardDetails {
  Tag?: string;
  PaymentType: 'CARD';
