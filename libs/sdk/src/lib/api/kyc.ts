...
export type KycDocumentStatus = 'CREATED' | 'VALIDATION_ASKED' | 'VALIDATED' | 'REFUSED' | 'OUT_OF_DATE';
export type KycDocumentType = 'IDENTITY_PROOF' | 'REGISTRATION_PROOF' | 'ARTICLES_OF_ASSOCIATION' | 'SHAREHOLDER_DECLARATION' | 'ADDRESS_PROOF';
export type KycDocumentRefusalReason = 'DOCUMENT_UNREADABLE' | 'DOCUMENT_NOT_ACCEPTED' | 'DOCUMENT_HAS_EXPIRED' | 'DOCUMENT_INCOMPLETE' | 'DOCUMENT_MISSING' | 'DOCUMENT_DO_NOT_MATCH_USER_DATA' | 'DOCUMENT_DO_NOT_MATCH_ACCOUNT_DATA' | 'SPECIFIC_CASE' | 'DOCUMENT_FALSIFIED' | 'UNDERAGE_PERSON' | 'SPECIFIC_CASE';
/**
...
export interface CreateKycDocument {
  Tag?: string;
